...
| Guide | Contents |
|-------|----------|
| [Frontend](frontend.md) | React SPA — setup, routing, auth, API integration, state management |
| [Backend](backend.md) | Laravel API + Python RAG service — endpoints, data models, Celery, testing |
| [Blog](blog.md) | Astro content site — content management, routing, SEO, deployment |
